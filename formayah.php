...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="formibu.php">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_ayah" id="nama_ayah"
                            ...
                            placeholder="Nama Ayah" value="<?php echo $nama_ayah; ?>"> <span
                            class="warning"><?php echo $error_nama_ayah ?></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="tahun_lahir" id="tahun_lahir"
                            ...
                            placeholder="Tahun Lahir Ayah" value="<?php echo $tahun_lahir; ?>"> <span
